...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleAccessDeniedException(AccessDeniedException e, WebRequest request) {
        ...
        Problem problem = createProblemBuilder(status, ProblemType.ACESSO_NEGADO, detail).build();
        problem.setUserMessage("Você não possui permissão para executar esta operação");
